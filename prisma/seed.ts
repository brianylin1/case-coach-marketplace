...
const coaches = [
  ...
  },
  {
    ...
    title: "Associate",
    yearsAtFirm: 0,
    headline: "Just got the offer. Happy to pay it forward.",
    bio: "Incoming McKinsey Associate, fresh off the recruiting process. I remember exactly what it felt like, and I run free mock interviews for first-generation and non-target candidates. Let's get your reps in.",
  ...
  },
  {
    ...
    bio: "Incoming BCG Consultant in Singapore. My style is low-pressure and rep-heavy. We'll work through enough cases together that the format stops feeling scary and you can focus on the actual thinking.",
